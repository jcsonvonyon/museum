...
export default function SectionHero() {
    ...
    return (
        <div ref={ref} className='safe-x-padding mt-24 mb-[172px]' aria-label='Hero Section'>
            <div className='grid grid-flow-row gap-10 xl:grid-cols-2 xl:grid-flow-col xl:gap-0'>
                ...
                <div className='flex flex-col items-center justify-center order-2 xl:items-start xl:order-1'>
                    <motion.p
                        ...
                        aria-label="Welcome to Virtual Museum"
                    >
                        Welcome to Virtual Museum
                    </motion.p>
                    <motion.h2
                        className='font-montserrat font-extrabold text-3xl md:text-[64px] md:leading-[56px] lg:text-[66px] lg:leading-[88px] text-transparent bg-gradient-to-r from-[#A293FF] to-[#00F0FF] bg-clip-text mb-6 text-center xl:text-left'
                        aria-label="SERVICE CIVIL INTERNATIONAL"
                    >
                    ...
                    >
                        Welcome To Our Virtual Museum , presented by SCI ,a pioneering peace organization.I&apos;m Raghav Your Guide
                    </motion.p>
                </div>
                {/* second */}
